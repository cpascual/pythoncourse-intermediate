# This File has been trivially adapted from the Taurus project to make it 
# work outside Taurus.
...
def loadUi(obj, filename=None, path=None, with_ui=None):
    ...
    is defined in a file /home/homer/workspace/foo/my_widget.py then it uses
    the path /home/homer/workspace/foo/ui)
